...
local function createRecoverySystem()
    ...
    file.writeLine("        print(\"In development\")")
    file.writeLine("    else")
    ...
    file.writeLine("print(\"Press Ctrl+T to restart\")")
    file.writeLine("while true do")
    file.writeLine("    write(\"root:\" .. currentPartition .. \"#> \")")
    file.writeLine("    ")
    file.writeLine("    -- Handle input with terminate event detection")
    file.writeLine("    local event, key = os.pullEvent()")
    file.writeLine("    ")
    file.writeLine("    if event == \"terminate\" then")
    file.writeLine("        print(\"\")")
    file.writeLine("        print(\"Restarting CloudOS...\")")
    file.writeLine("        sleep(1)")
    file.writeLine("        os.reboot()")
    file.writeLine("    elseif event == \"char\" or event == \"key\" then")
    file.writeLine("        -- Put the event back and read the line normally")
    file.writeLine("        os.queueEvent(event, key)")
    ...
    file.writeLine("                print(\"  Ctrl+T                   - Restart computer\")")
    file.writeLine("            elseif command == \"restart\" or command == \"reboot\" then")
    file.writeLine("                print(\"Restarting CloudOS...\")")
    file.writeLine("                sleep(1)")
    file.writeLine("                os.reboot()")
    file.writeLine("            else")
